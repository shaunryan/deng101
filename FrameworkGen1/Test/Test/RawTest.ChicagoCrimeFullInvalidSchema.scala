...
// MAGIC ###Source format errors above threshold
...
//not corrently partitioned. If Partitioned chucking in the partition column and format will siginificantly improve performance of the delete
