...
dbutils.notebook.run("/AzureDataFactory/MailroomIncoming/test/RunTests2", 3600, Map("testRunId" -> testRunId, "environment" -> environment))
...
TestReport.collateTestReport(testRunId, environment, true)
...
dbutils.notebook.run("/AzureDataFactory/MailroomIncoming/test/ClearDownTestData", 3600)
