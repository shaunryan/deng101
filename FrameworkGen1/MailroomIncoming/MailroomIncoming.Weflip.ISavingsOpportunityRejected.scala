...
val dfPrep = dfraw          
          ...
          .select(
            ...
            $"shredded.CalculatedAnnualCosts".as("CalculatedAnnualCosts"),
            $"shredded.CalculatedSavings".as("CalculatedSavings"),
            $"shredded.CurrentAnnualCosts".as("CurrentAnnualCosts"),
            $"shredded.RejectionFeedback".as("RejectionFeedback"),
