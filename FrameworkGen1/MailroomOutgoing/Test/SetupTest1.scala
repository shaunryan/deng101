...
val testData = sqlContext.read.format("csv")
  ...
  .option("quote", "\"")
  .option("escape", "\"")
  .load("adl://gcdatabricksdlsdev.azuredatalakestore.net/raw/mailroomoutgoing/testdata/iLikelySavingsOpportunityFound.csv")
...
// MAGIC %sql
// MAGIC 
// MAGIC select * from SavingsEngine.weflip_ilikelysavingsopportunityfound where LoadDate = '1900-01-01T00:00:00.000+0000'
